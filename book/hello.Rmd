...
Like in Rust, creating a variable requires two steps, declaration and initialization. In C++, there are many different ways to perform these steps.
...
The value will be implicitly truncated to an integer, effectively erasing the decimal component (although recent compilers do provide a warning; see Figure \@ref(fig:equal)).

An often preferred method of initialization is to use curly braces, as seen in the example below:
